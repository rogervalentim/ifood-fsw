    ...
    <div>
      ...
      <div className="hidden px-32 lg:flex lg:gap-8 lg:pt-10">
        <Image
          ...
          alt={restaurant.name}
          className="rounded-md object-cover lg:h-[380px] lg:w-[750px]"
          height={0}
          width={0}
          sizes="100vw"
          quality={100}
        ...
        <div className="w-[310px]">
          ...
          <div className="mt-3 hidden gap-4 overflow-x-scroll px-5 lg:flex lg:px-0 [&::-webkit-scrollbar]:hidden">
          ...
          <div className="mt-6 space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              deleniti ipsa ea deserunt enim corporis quas consequatur esse
              facilis repellendus sint nihil necessitatibus, animi ullam officia
              tenetur possimus quibusdam error!
            </p>
          </div>
        </div>
      </div>
